...
class LoadingCenter extends StatefulWidget {
  ...
  LoadingCenter({this.color1 = base, this.color2 = accent, this.color3 = Colors.lightGreen});

  @override
  _ColorLoader2State createState() => _ColorLoader2State();
}

class _ColorLoader2State extends State<LoadingCenter> with TickerProviderStateMixin {
